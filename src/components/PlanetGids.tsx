...
const PLANETEN: Planet[] = [
  ...
  },
  {
    ...
    weetje: 'Venus draait de verkeerde kant op! De zon gaat er in het westen op.',
  },
  {
    naam: 'Aarde',
  ...
  },
  {
    ...
    weetje: 'De Grote Rode Vlek is een storm die al minstens 350 jaar woedt. Één storm!',
  },
  {
    naam: 'Saturnus',
  ...
  },
  {
    ...
    weetje: 'Het is zo koud op Uranus (-224°C) dat zelfs het gas bevroren is.',
  },
  {
    naam: 'Neptunus',
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-400 mt-2 text-base font-semibold">
            Klik op een planeet om meer te ontdekken!
          </p>
        </motion.div>
              ...
              <div className="flex flex-col md:flex-row gap-6 items-start">
                ...
                <div className="flex-1">
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-5">
                    ...
                    <StatPill label="Afstand tot aarde" value={actief.afstand} sub="" />
                    <StatPill label="1 jaar duurt" value={actief.jaar} sub="op aarde" />
                  </div>

                  <div className="p-4 rounded-2xl bg-white/10 mb-4 flex items-start gap-2">
                    <Sparkles size={16} className="text-amber-400 flex-shrink-0 mt-0.5" />
                    <p className="text-white font-bold text-sm">{actief.feit}</p>
                  </div>

                  <div className="p-4 rounded-2xl bg-amber-400/15 border border-amber-400/30 flex items-start gap-2">
